...
export const ALGO_ABI_METHODS = {
  GAS: 'gas()void',
  ADD_STAKE: 'addStake(pay,uint64,uint64)(uint64,uint64,uint64)',
  REMOVE_STAKE: 'removeStake(uint64,uint64,uint64)(uint64)',
  FIND_POOL_FOR_STAKER: 'findPoolForStaker(uint64,address,uint64)((uint64,uint64,uint64),bool,bool)',
